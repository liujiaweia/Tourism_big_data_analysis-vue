<template>
  <div class="app-container">
    ...
    <el-input v-model="state" placeholder="请输入去过的酒店名称" />

    <el-input v-model="citya" placeholder="现在城市" />
    ...
    >
      ...
      <el-table-column label="酒店类型" width="110" align="center">
        <template slot-scope="scope">
          {{ scope.row.type }}
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    search() {
      ...
      getSimilarhotel(this.state, this.citya)
        .then(res => {

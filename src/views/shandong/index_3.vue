<template>
  <div id="app">
    <el-row :gutter="350">
      <el-col :xs="500" :sm="24" :md="12" :lg="6" :xl="6">
        <div id="echarts_1" style="width:500px; height:460px"></div>
      </el-col>
      <el-col :xs="500" :sm="24" :md="12" :lg="6" :xl="6">
        <div id="echarts_2" style="width:750px; height:495px"></div>
      </el-col>
    </el-row>
    <el-row :gutter="500">
      <el-col :xs="500" :sm="24" :md="12" :lg="6" :xl="6">
        <div id="echarts_3" style="width:550px; height:480px"></div>
      </el-col>
      <el-col :xs="500" :sm="24" :md="12" :lg="6" :xl="6">
        <div id="echarts_4" style="width:550px; height:450px"></div>
      </el-col>
    </el-row>
    <el-row :gutter="350">
      <el-col :xs="500" :sm="24" :md="12" :lg="6" :xl="6">
        <div id="echarts_5" style="width:500px; height:500px"></div>
      </el-col>
      <el-col :xs="500" :sm="24" :md="12" :lg="6" :xl="6">
        <div id="echarts_6" style="width:750px; height:500px"></div>
      </el-col>
    </el-row>
    <el-row :gutter="350">
      <el-col :xs="500" :sm="24" :md="12" :lg="6" :xl="6">
        <div id="echarts_7" style="width:480px; height:500px"></div>
      </el-col>
      <el-col :xs="500" :sm="24" :md="12" :lg="6" :xl="6">
        <div id="echarts_8" style="width:750px; height:500px"></div>
      </el-col>
    </el-row>
    <el-row :gutter="350">
      <div id="echarts_9" style="width:1300px; height:500px"></div>
    </el-row>
  </div>
</template>
...
export default {
  mounted() {
    ...
    var myChart1 = echarts.init(document.getElementById("echarts_2"));
    var myChart2 = echarts.init(document.getElementById("echarts_3"));
    var myChart3 = echarts.init(document.getElementById("echarts_1"));
    var myChart4 = echarts.init(document.getElementById("echarts_5"));
    var myChart5 = echarts.init(document.getElementById("echarts_6"));
    var myChart6 = echarts.init(document.getElementById("echarts_7"));
    var myChart7 = echarts.init(document.getElementById("echarts_8"));
    var myChart8 = echarts.init(document.getElementById("echarts_9"));
      ...
      series: [
        {
          ...
          stack: "总量",
          areaStyle: {},
          data: [449, 358, 103, 367, 206, 225, 294]
        },
        {
          name: "咖啡厅",
          type: "line",
      ...
      series: [
        {
          ...
          type: "line",
          smooth: true,
          data: [8, 19, 3, 9, 13, 12, 14]
        },
        {
          name: "尚客优酒店",
          type: "line",
          smooth: true,
          data: [47, 31, 2, 22, 6, 13, 25]
        },
        {
          name: "7天酒店",
          type: "line",
          smooth: true,
          data: [26, 35, 8, 17, 6, 6, 6]
        },
        {
          name: "银座佳驿",
          type: "line",
          smooth: true,
          data: [10, 56, 6, 9, 5, 2, 16]
        },
        {
          name: "希尔顿酒店",
          type: "line",
      ...
      series: [
        {
          ...
          center: ["50%", "60%"],
          data: [
            { value: 26153, name: "格林豪泰酒店" },
            { value: 50601, name: "尚客优酒店" },
            { value: 36257, name: "7天酒店" },
            { value: 40879, name: "银座佳驿" },
            { value: 8764, name: "希尔顿酒店" }
          ],
          emphasis: {
            itemStyle: {
              shadowBlur: 10,
    ...
    myChart4.setOption({
      title: {
        text: "住宿服务，客房WiFi，24小时前台在山东省酒店中的数量",
        textStyle: {
          color: "#235894"
        }
      },
    ...
    myChart5.setOption({
      ...
      series: [
        {
          data: [2, 26, 26, 24, 4, 1, 7, 15, 10, 20, 11, 3, 3, 1, 6, 20, 23],
          type: "bar"
        }
      ]
    });
    myChart6.setOption({
      ...
      yAxis: {
        ...
        data: [
          ...
          "泰安星期八别墅",
          "济南李东霞别墅(6号店)",
          "济南'Soulmate度假别墅(开拓路分店)",
          "济南Soulmate度假别墅(工业南路分店)",
          "济南索菲特银座大饭店",
          "莱州贤人公寓",
          "桔子酒店·精选(青岛海尔路店)",
          "济南轰趴小绿度假别墅(舜华北路分店)",

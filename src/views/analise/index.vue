<template>
  <div class="app-container">
      ...
      <el-input placeholder="请输入需要分析评论" v-model="state" class="input-with-select">
    ...
    >
      ...
      <el-table-column label="评论分析结果" width="110" align="center">
        <template slot-scope="scope">
...
<script>
import { getcomment } from '@/api/table'
